...
router.get(
  ...
  authorize(['super', 'admin', 'suport', 'reviewer']),
  validateInputs(singleAdminLogsValidator.single_admin_logs_params_schema , "params"),
  validateInputs(singleAdminLogsValidator.single_admin_logs_query_schema , "query"),
  AdminAccessLogsControllers.getSingleAdminAccessLogs
);
router.get(
  paths.getAllAccessLogs,
  authorize(['super', 'admin', 'reviewer']),
